              ...
              TextButton(
                  ...
                  onPressed: () async {
                    ...
                    if (result != null) {
                      ...
                      getAllUserDetails();
                      _showSuccessSnackBar('Agenda Deletada com Sucesso');
                    }
                  },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 202, 209, 230),
        actions: [
          IconButton(
              onPressed: () async {
                await getAllUserDetails();
                _showSuccessSnackBar('Lista Atualizada');
              },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
            ...
            if (data != null) {
              getAllUserDetails();
              _showSuccessSnackBar('Agenda Adicionada com Sucesso');
            }
          });
        },
